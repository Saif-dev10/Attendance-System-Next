...
export function Dashboard() {
  ...
  return (
    <>
      <link rel="icon" href={dashboardIcon} />

      <Header title="Dashboard" subtitle="Your attendance at a glance" />
      ...
      <div className="fixed inset-0 z-10 hidden" />
      ...
      <main className="max-w-[900px] ml-[350px] mx-auto px-5 py-8 font-[Segoe_UI]">
        ...
        {/* ACTION */}
        <div className="grid grid-cols-2 gap-4 mb-8 max-[640px]:grid-cols-1">
          <button
          ...
          >
            📅
            <div className="flex-1">
              <h3 className="font-semibold text-black">Edit Timetable</h3>
        ...
        {/* SEMESTER */}
        {semesterDates && (
          <div className="p-5 rounded-xl shadow-sm mb-7">
